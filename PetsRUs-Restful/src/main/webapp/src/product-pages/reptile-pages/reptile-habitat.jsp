...
<%
    ...
    String jsonResponse =
    target.path("api").path("v1").path("products").path("1000000009").
            request().
    ...
    out.println("<title>Reptile Habitat</title>");
    out.println("</head>");
    out.println("<body>");
    ...
    out.println("<h3 id=\"product-name\">Reptile Habitat</h3>");
    out.println("</div>");
    out.println("<div class=\"col-2\"></div>");
    out.println("</div>");
    ...
    out.println("<input  name=\"price\" type=\"text\" class=\"form-control\" id=\"price\" value=\"" + product.getPrice() + "\" readonly>");
    out.println("</div>");
    out.println("<div class=\"form-group col-md-4\">");
